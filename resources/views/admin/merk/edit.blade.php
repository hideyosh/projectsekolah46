...
<div class="card m-4">
    ...
    <div class="card-body">
        <div class="basic-form">
            <form class="form-valide-with-icon" method="POST" action="{{ route('merk.update', $merk->id) }}" novalidate="">
                @if ($errors->any())
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="val-username1" name="nama_merk" required="" value="{{ $merk->nama_merk }}">
                    </div>
                </div>
