...
<div class="card m-4">
    ...
    <div class="card-body">
        <div class="basic-form">
            <form class="form-valide-with-icon" method="POST" action="{{ route('tipe.store') }}" novalidate="">
                @if ($errors->any())
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="val-username1" name="nama_tipe" required="" placeholder="Enter a nama tipe.." value="{{ old('nama_tipe') }}">
                    </div>
                </div>
